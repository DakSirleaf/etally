      ...
      >
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] font-body mt-0.5" style={{ color: textSecondary }}>
                        Your schedule shows <span className="font-bold">{scheduleDay?.type?.toUpperCase()}</span> for this date. Confirm before saving.
                      </p>
                    </div>
                  </div>
        ...
        <AnimatePresence mode="wait">
          {shiftType === 'CALLOUT' ? (
            ...
            >
              <div className="rounded-2xl px-4 py-4 flex flex-col overflow-hidden relative"
